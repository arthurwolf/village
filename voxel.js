var createGame = require('voxel-engine');", "var game = createGame({
...
});", "//game.appendTo(document.body);", "/*var player = require('voxel-player');
var createPlayer = player(game);", "var avatar = createPlayer('player.png');
avatar.possess();
